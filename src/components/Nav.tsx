...
export default function Nav({setTyping, location, handleLocation, totalGuests, isMobile}: Props): ReactElement {
    ...
    return (
    <>
        {isMobile && <a href='/'><img className='siteLogo' alt="logo" src={logo} /></a>}
        <nav>
            {isMobile || <a href='/'><img className='siteLogo' alt="logo" src={logo} /></a>}
